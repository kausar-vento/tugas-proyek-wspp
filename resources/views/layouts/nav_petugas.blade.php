...
<body>
    ...
    <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="#">{{Auth::guard('webpetugas')->user()->nama_petugas}}</a>
        ...
        <div class="navbar-nav">
            <div class="nav-item text-nowrap">
                <a class="nav-link px-3" href="{{route('petugas.logoutPetugas')}}">Sign out</a>
            </div>
        </div>
    </header>
            ...
            <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                <div class="position-sticky pt-3">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('home-petugas') ? 'active' : ''}}" aria-current="page" href="/home-petugas">
                                <span data-feather="home"></span>
                                Home Murid
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ Request::is('petugas-laporan') ? 'active' : ''}}" href="/petugas-laporan">
