...
<div class="card">
    <h5 class="card-header">Form Edit Spp</h5>
    <form action="{{route('admin-spp.update', $data->id)}}" method="post">
        @method('PUT')
        @csrf
        <div class="card-body">
            <div class="input-group mb-3">
                ...
                <input type="number" name="tahun_ajaran"
                    ...
                    aria-label="Username" aria-describedby="basic-addon1" value="{{ old('tahun_ajaran', $data->tahun_ajaran)}}">
                @error('tahun_ajaran')
        ...
        <div class="input-group mb-3">
            ...
            <input type="date" name="batas_pembayaran"
                ...
                aria-label="Username" aria-describedby="basic-addon1" value="{{ old('batas_pembayaran', $data->batas_pembayaran)}}">
